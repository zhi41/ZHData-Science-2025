...
- Is there "one true value" for the material properties of Aluminum?
  - No. Aluminum’s elastic modulus E and Poisson’s ratio nu which changes the value of material properties of aluminum.
...
- (Write your own question here)
  -investigate if there is a relationship between E and nu 
...
- the correlation coefficient 0.667717 between young's modulus and poisson's ratio indicated a positive relationship between these two property for this alloy al_24st. which means as young's modulus increases, poisson's ratio tends to increase. however it is not very strong correlation. furthermore the plot shows the dataset being very spread out and far from the regression line, with a wide confidence interval, which further suggest that the association between E and nu is not strong.
...
- Does this graph support or contradict the claim above?
  - the graph is plotting E against nu, with the color representing thickness. the plot shows a distinct cluster of larger thickness 0.081 at the bottom left while smallest thickness E>10500,occupying the top part of the graph. The distinct cluster of 0.081 seems to suggest E and nu depend on the thickness of the material. The plot also show some relationship between the thickness and E property, where smaller thickness shows Higher.
  
- Is this evidence *conclusive* one way or another?
  - to a large extend it is not conclusive.Though the graph shows a possible relationship between thickness, E and nu, the lack of distinct differences across the thickness and the property and lack of number of data points makes the evidence not necessary conclusive. The similarity between thick 0.064 and thick 0.032 and lack of distinct cluster also makes it less conclusive ( this maybe due to the critical point of change of elasticity being between 0.081 to 0.064 ).
