...
- What *overall* trend do you see between `SE` and population? Why might this trend exist?
  - As the population increases the standard error decreases.Larger populations generally provide more data and sample size, which reduces uncertainty in the estimate.Furthermore the standard error is inversely related to sample size.
